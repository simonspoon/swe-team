...
|--------|-------|------|-------|
| architecture | Rust CLI patterns (API wrappers) | [architecture/rust-cli-patterns.md](architecture/rust-cli-patterns.md) | 2026-03-14 |
| architecture | Rust CLI + SQLite scaffold | [architecture/rust-cli-sqlite-scaffold.md](architecture/rust-cli-sqlite-scaffold.md) | 2026-03-24 |
