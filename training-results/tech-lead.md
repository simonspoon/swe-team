...
| 12 | Unclaim | core | `limbo unclaim` releases ownership |
| 13 | Delete and prune | cleanup | `limbo delete` and `limbo prune` remove tasks |
| 14 | (removed) | -- | Gate validation removed from limbo |
...
| 9 | (removed) | N/A | Templates removed from limbo | -- | -- |
| 10 | Notes | PASS | -- | -- | -- |
| 11 | Tree with --show-all | PASS | -- | -- | -- |
| 12 | Unclaim | PASS | -- | -- | -- |
| 13 | Delete and prune | PASS | -- | -- | -- |
| 14 | (removed) | N/A | Gate validation removed from limbo | -- | -- |
